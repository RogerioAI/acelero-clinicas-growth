...
export const BlogTOC = ({ headings }: Props) => {
  ...
  return (
    <>
      ...
      <aside className="hidden lg:block sticky top-28 self-start max-h-[calc(100vh-8rem)] overflow-y-auto pr-4 border-l border-border pl-4">
