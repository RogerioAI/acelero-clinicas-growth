      ...
      <div className="container mx-auto px-4">
        <div className="max-w-6xl mx-auto">
          ...
          <div className="relative">
            {/* Vertical Line */}
            <div className="absolute left-[calc(2rem-0.125rem)] md:left-[calc(50%-0.125rem)] top-0 bottom-0 w-0.5" style={{ backgroundImage: 'linear-gradient(to bottom, hsl(220, 60%, 12%), #17C8D0, hsl(220, 60%, 12%))' }} />
