  ...
  const steps = [
    {
      ...
      description: "Diagnóstico profundo para entender onde a clínica está e para onde precisa ir",
      icon: Target,
    },
    {
      letter: "C",
      title: "Canais de Aquisição",
      description: "Definição dos canais que vão alimentar o crescimento da clínica com previsibilidade",
      icon: Users2,
    },
    {
      letter: "E",
      title: "Estrutura Comercial",
      description: "Organização do processo comercial em pré-venda, venda e pós-venda",
      icon: Building2,
    },
    {
      letter: "L",
      title: "Liderança Comercial",
      description: "Formação do gestor para liderar pessoas, rotina e crescimento comercial",
      icon: Trophy,
    },
    {
      letter: "E",
      title: "Engrenagem de Vendas",
      description: "Implantação das ferramentas que dão sustentação à execução comercial",
      icon: Zap,
    },
    {
      letter: "R",
      title: "Rampagem Comercial",
      description: "Acompanhamento intenso da execução para corrigir, consolidar e acelerar resultados",
      icon: TrendingUp,
    },
    {
      letter: "O",
      title: "Ousadia para Escalar",
      description: "Novo ciclo de crescimento para quem já estruturou a base e quer subir o patamar",
      icon: Rocket,
    },
  ];
