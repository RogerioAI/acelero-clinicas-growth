    ...
    <section className="py-24 bg-primary text-primary-foreground">
      <div className="container mx-auto px-4">
        <div className="max-w-4xl mx-auto text-center">
          ...
          {/* Highlight Box */}
          <div className="bg-primary-light/50 rounded-2xl p-8 md:p-12 shadow-lift mb-8 border border-cyan/20">
            <p className="text-xl md:text-2xl leading-relaxed">
              A Mentoria <span className="font-bold text-cyan">A.C.E.L.E.R.O</span> estrutura sua área comercial do zero, 
              com metodologia prática, validada em{" "}
              <span className="font-bold text-cyan">mais de 250 clínicas</span> no Brasil.
            </p>
          </div>
